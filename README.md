            ...
            <table style="width:65%">
                ...
                <tr>
                  ...
                  <td>
                      ENGLISH.
                      <br>
                      It’s a small video game developed with Unity. This game possesses mechanics that are reminiscent of the platform genre, where the player has the                       ability to jump between sections of the map and to stomp on enemies in order to progress the level; besides, there are two extra actions that                           allow the player to attack (the enemies) and evade attacks, all of this with the purpose of providing a fluid and fun gameplay experience.                             <br><br>
                      SPANISH.
                      <br>
